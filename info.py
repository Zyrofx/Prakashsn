...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002350541378').split()]
...
# Others
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+6eQvMKueEfcxNDNl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+LamO1iWVqpQwMWQ1')
